...
class RpcClient:
    ...
    def __init__(self) -> None:
        ...
        self._last_received_ping: datetime = datetime.now()
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        def dorpc(*args, **kwargs):
            ...
            # Generate request
            req: list = [self.client_id, name, args, kwargs]
            ...
            if rep[0]:
                ...
                raise Exception("Invalid client id or function is not registered on the server side.")
    ...
    def start(self, req_address: str, sub_address: str) -> None:
        ...
        self._last_received_ping = datetime.now()
    ...
    def run(self) -> None:
        ...
        while self._active:
            ...
            topic = topic.decode("utf-8")  # topic = str(topic, "utf-8")
    ...
    def on_disconnected(self):
        ...
        """
        msg: str = f"[{datetime.now()}] RpcServer has no response over {HEARTBEAT_TOLERANCE} seconds, please check you connection."
        print(msg)
